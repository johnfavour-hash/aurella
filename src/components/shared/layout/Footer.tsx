...
const Footer = () => {
  return (
    <Box
      ...
      opacity="1"
    >
      <Stack w="full" maxW="1240px" mx="auto" h="332px" gap="34px">
        {/* Main Footer Content Area */}
        <Stack w="full" maxW="1240px" mx="auto" h="278px" gap="34px" opacity="1">
          ...
          <Stack direction={{ base: "column", lg: "row" }} w="full" maxW="1240px" mx="auto" h="208px" gap="200px" align="flex-start">
        ...
        <Flex w="full" maxW="1240px" mx="auto" h="20px" justify="space-between" align="center" opacity="1">
